...
```{r}
markers_LN <- readRDS("Rds/LN")
markers_CLR <- readRDS("Rds/CLR")
markers_CLRc <- readRDS("Rds/CLRc")
markers_RC <- readRDS("Rds/RC")
markers_SCT <- readRDS("Rds/SCT")
markers_SCTGLM <- readRDS("Rds/SCTGLM")
```
